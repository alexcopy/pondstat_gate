...
export class DeviceMySuffixComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.deviceService
                ...
                .subscribe(
                    (res: HttpResponse<IDeviceMySuffix[]>) => this.paginateDevices(res.body, res.headers),
    ...
    trackId(index: number, item: IDeviceMySuffix) {
        return item.id;
    }
    ...
    private paginateDevices(data: IDeviceMySuffix[], headers: HttpHeaders) {
