...
import { ILocationMySuffix } from 'app/shared/model/pond/location-my-suffix.model';
...
export class LocationMySuffixService {
    private resourceUrl = SERVER_API_URL + 'pond/api/locations';
    private resourceSearchUrl = SERVER_API_URL + 'pond/api/_search/locations';
