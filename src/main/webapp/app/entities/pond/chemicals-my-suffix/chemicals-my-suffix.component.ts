...
@Component({
    selector: 'jhi-chemicals-my-suffix',
    templateUrl: './chemicals-my-suffix.component.html'
})
export class ChemicalsMySuffixComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.chemicalsService
                ...
                .subscribe(
                    (res: HttpResponse<IChemicalsMySuffix[]>) => this.paginateChemicals(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/chemicals-my-suffix'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IChemicalsMySuffix) {
        return item.id;
    }
    ...
    private paginateChemicals(data: IChemicalsMySuffix[], headers: HttpHeaders) {
