package ru.gpsbox.gate.repository;

import ru.gpsbox.gate.GateApp;
import ru.gpsbox.gate.config.Constants;
import ru.gpsbox.gate.config.audit.AuditEventConverter;
import ru.gpsbox.gate.domain.PersistentAuditEvent;
...
import static ru.gpsbox.gate.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
