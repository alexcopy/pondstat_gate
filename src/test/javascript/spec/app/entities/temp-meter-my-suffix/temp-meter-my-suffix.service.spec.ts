...
describe('Service Tests', () => {
    ...
    describe('TempMeterMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TempMeterMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + '/pond/api/temp-meters';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TempMeterMySuffix', () => {
