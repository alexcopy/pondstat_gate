...
describe('Service Tests', () => {
    describe('TrainedModelMySuffix Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a TrainedModelMySuffix', () => {
                service.create(new TrainedModelMySuffix(null)).subscribe(received => {
            ...
            it('should update a TrainedModelMySuffix', () => {
                service.update(new TrainedModelMySuffix(123)).subscribe(received => {
            ...
            it('should return a TrainedModelMySuffix', () => {
            ...
            it('should return a list of TrainedModelMySuffix', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new TrainedModelMySuffix(123)]);
            });

            it('should delete a TrainedModelMySuffix', () => {
