...
describe('Service Tests', () => {
    describe('SelectedKeyWordsMySuffix Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a SelectedKeyWordsMySuffix', () => {
                service.create(new SelectedKeyWordsMySuffix(null)).subscribe(received => {
            ...
            it('should update a SelectedKeyWordsMySuffix', () => {
                service.update(new SelectedKeyWordsMySuffix(123)).subscribe(received => {
            ...
            it('should return a SelectedKeyWordsMySuffix', () => {
            ...
            it('should return a list of SelectedKeyWordsMySuffix', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new SelectedKeyWordsMySuffix(123)]);
            });

            it('should delete a SelectedKeyWordsMySuffix', () => {
