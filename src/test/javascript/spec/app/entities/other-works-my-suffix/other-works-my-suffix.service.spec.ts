...
describe('Service Tests', () => {
    ...
    describe('OtherWorksMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(OtherWorksMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + '/pond/api/other-works';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return OtherWorksMySuffix', () => {
