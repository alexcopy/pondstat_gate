...
describe('Service Tests', () => {
    ...
    describe('VkGroupMySuffix Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(VkGroupMySuffixService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + '/vkbot/api/vk-groups';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return VkGroupMySuffix', () => {
